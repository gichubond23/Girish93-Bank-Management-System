...
public class Query9 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(city.isEmpty())
        JOptionPane.showMessageDialog(null,"Please enter a city to proceed");
        else
        {
        try
            {
                ...
                String query="select a.customer_id,a.customer_name,a.contact_no from customers a,address b,belongs_to c where a.branch_id=c.branch_id and a.address_id=b.address_id and b.city='"+city+"';";
