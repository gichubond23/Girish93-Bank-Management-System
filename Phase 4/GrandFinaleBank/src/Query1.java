...
public class Query1 extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AllBranchesParBank
     */
    public Query1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enter the Bank Name");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String bankname=t1.getText();
        if(bankname.isEmpty())
            JOptionPane.showMessageDialog(null,"Please enter a bank name to proceed");
        else
        {
            try
            {
                ...
                String query="select a.branch_name,b.bank_name from branch a,bank b where a.bank_id=b.bank_id and b.bank_name='"+bankname+"';";
